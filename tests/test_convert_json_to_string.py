...
maps stored on `differential.revision.reviewers` transactions into a
comma-separated list of reviewer names.
...
# and asserts the joined reviewer-name string it produces. The empty/fallback
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            "alice",
            "a PHID resolving to None is dropped from the joined output",
